<template>
  <div class="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
    ...
    <div class="w-full bg-black/5 p-4 text-center">
      ...
      <a href="https://studio24.bg/tsentar-za-estetichna-i-holistichna-meditsina-adoree-s1280?m&">Center
        Adoree</a>
    </div>
  </div>
</template>
